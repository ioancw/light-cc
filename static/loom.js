...
function renderMessages() {
  ...
  if (!conv || conv.messages.length === 0) {
    container.innerHTML = `<div class="empty-state">
      <div class="empty-logo"><svg width="24" height="28" viewBox="0 0 10 12" fill="none"><path d="M6 0L0 7h4l-1 5 6-7H5l1-5z" fill="#fff"/></svg></div>
...
function renderMessageHTML(msg) {
  ...
  return `<div class="msg-row assistant-row" id="msg-${msg.id}" data-msg-id="${msg.id}">
    <div class="msg-avatar ai-av"><svg width="14" height="16" viewBox="0 0 10 12" fill="none"><path d="M6 0L0 7h4l-1 5 6-7H5l1-5z" fill="#fff"/></svg></div>
    <div class="msg-body">
      <div class="msg-header">
